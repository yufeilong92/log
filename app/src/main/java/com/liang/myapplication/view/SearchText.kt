...
class SearchText : ConstraintLayout {
    ...
    private lateinit var onEditonActionlistenre: (com: String?) -> Unit
    ...
    fun setEditoAcitonListener(onEditoAcitonListener:(com:String?)->Unit) {
        onEditonActionlistenre=onEditoAcitonListener
    }
